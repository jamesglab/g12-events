...
export class AppComponent implements OnInit {
  ...
  constructor(public translate: TranslateService) {
    translate.addLangs(['es', 'en', 'pt', 'fr']);
  }
  ...
  ngOnInit() {
    ...
    localStorage.clear();
    localStorage.setItem('language', currentLanguage.toString().toLowerCase());
  }
  ...
  createKeybe() {
    ...
    script.src =
      'https://storage.googleapis.com/keybejs/4.7.2/keybe.js?version=4.7.2';
