...
export const donation_errors = {
  ...
  personal_information: {
    ...
    document: [
      ...
      {
        type: 'minlength',
        message: 'El documento debe tener mas de 6 dígitos',
      },
      {
        type: 'maxlength',
  ...
  1: {
    ...
    cardYear: [{ type: 'required', message: 'Escribe año de vencimiento' }],
  },
  2: {
...
export const error_messages = [
...

  {
    ...
    address: [
      {
        type: 'pattern',
        message: 'No puedes poner caracteres que no sean una dirección',
      },
      {
        type: 'maxlength',
